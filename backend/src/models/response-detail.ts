...
import { SuccessSendSMSResponse, SuccessInstantLinkResult, AuthUrlResponse } from '@src/services/possession/(definitions)';
...
export interface ResponseDetailPayload {
  success_auth_url_response?: Partial<AuthUrlResponse>; 
