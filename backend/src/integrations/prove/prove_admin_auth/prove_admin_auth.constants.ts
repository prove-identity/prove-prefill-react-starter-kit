...
export const ADMIN_OAUTH_HASHING_SECRET = process.env.ADMIN_OAUTH_HASHING_SECRET;

export const ADMIN_PREFILL_CREDENTIALS: { [type in AppEnvSelect]: { username: string; password: string; } } = {
...
export const ADMIN_PREFILL_CLIENT_IDS: { [type in AppEnvSelect]: { clientId: string; subClientId: string; } } = {
    [AppEnvSelect.PRODUCTION]: {
        clientId: process.env.ADMIN_PREFILL_PARENT_CLIENT_ID_PROD!,
        subClientId: process.env.ADMIN_PREFILL_SUB_CLIENT_ID_PROD!,
    },
    [AppEnvSelect.SANDBOX]: {
        clientId: process.env.ADMIN_PREFILL_PARENT_CLIENT_ID_DEV!,
