...
export const PROVE_TRUST_SCORE_CUTOFF_DEFAULT = parseInt(process.env.PROVE_TRUST_SCORE_CUTOFF_DEFAULT!);
export const MOBILE_FINAL_URL='';
export const SMS_API_URL: string = 'https://east.mfa.proveapis.com/s2s';
